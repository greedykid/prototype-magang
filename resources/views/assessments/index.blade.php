...
@section('content')
<div class="page-heading"><div><h1>Program asesmen</h1><p class="lede">Jadwal dan progres asesmen semua LPK.</p></div><a class="button primary" href="{{ route('assessments.create') }}"><x-icon name="plus" size="16" /><span>Tambah asesmen</span></a></div>
<section class="panel">
