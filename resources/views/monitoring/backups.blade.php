...
@section('content')
<div class="page-heading"><div><span class="eyebrow">HISTORI OPERASIONAL</span><h1>Riwayat backup</h1><p class="lede">Catatan status backup manual. Halaman ini tidak menjalankan backup nyata.</p></div></div>
<section class="panel">
