                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between; gap: 16px; flex-wrap: wrap;">
                        <div style="flex: 1 1 420px; min-width: 0;">
                            <div style="margin-bottom: 6px;">
                                <div style="background-color: #e11d48; color: #ffffff; border-radius: 5px; padding: 3px 8px; font-weight: 700; font-size: 10.5px; text-transform: uppercase; letter-spacing: 0.5px; display: inline-flex; align-items: center; gap: 5px; white-space: nowrap;">
                        ...
                        <div style="display: flex; align-items: center; flex-shrink: 0;">
                            <a href="{{ route('lpks.index', ['surveillance' => 'NEEDS_ACTION']) }}" class="button primary" style="background-color: #e11d48; border-color: #e11d48; font-size: 12px; font-weight: 600; padding: 6px 14px; min-height: 32px; white-space: nowrap; display: inline-flex; align-items: center; gap: 6px; box-shadow: 0 1px 2px rgba(225, 29, 72, 0.2);">
