...
@section('content')
<div class="page-heading"><div><h1>Daftar LPK</h1><p class="lede">Kelola catatan dasar lembaga pengujian yang digunakan di prototype.</p></div><a class="button primary" href="{{ route('lpks.create') }}"><x-icon name="plus" size="16" /><span>Tambah LPK</span></a></div>
<section class="panel">
